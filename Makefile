# This Makefile is for the DownIt extension to perl.
#
...
#     NAME => q[DownIt]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0], YAML=>q[0], Dancer=>q[1.308] }
#     VERSION_FROM => q[lib/DownIt.pm]
#     clean => { FILES=>q[DownIt-*] }
...
TO_INST_PM = lib/DownIt.pm

PM_TO_BLIB = lib/DownIt.pm \
	blib\lib\DownIt.pm
...
DownIt.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"DownIt\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) "name:               DownIt" >> META_new.yml
	...
	$(NOECHO) $(ECHO) "    Dancer:      1.308" >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"Dancer::\" VERSION=\"1.308\" />" >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e "pm_to_blib({{@ARGV}, '$(INST_LIB)\auto', q[$(PM_FILTER)], '$(PERM_DIR)')" -- \
	  lib/DownIt.pm blib\lib\DownIt.pm 
